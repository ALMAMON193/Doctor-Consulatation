...
use App\Http\Resources\Dashboard\Consultation\ConsultationListResource;
use App\Http\Resources\Dashboard\Coupon\CouponDetailsResource;
use App\Http\Resources\Dashboard\Coupon\CreateCouponResource;
use App\Http\Resources\Dashboard\Coupon\ListCouponResource;
...
class CouponController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $coupons = [
            'analytics' => $analytics,
            'coupons' => ListCouponResource::collection($coupons),
            'pagination' => [
                'total' => $coupons->total(),
    ...
    public function store (CouponStoreRequest $request)
    {
        ...
        return $this->sendResponse (
            new CreateCouponResource($coupon),
