...
namespace App\Http\Controllers\API\WEB\Dashboard\Doctor;

use App\Http\Controllers\Controller;
use App\Http\Requests\WEB\Dashboard\Doctor\StoreRequest;
use App\Http\Resources\WEB\Dashboard\Doctor\DoctorDetailResource;
...
class DoctorApiController extends Controller
{
    ...
    public function doctorList(Request $request)
    {
        ...
        $collection = \App\Http\Resources\WEB\Dashboard\Doctor\DoctorListResource::collection($doctors)->resolve();
