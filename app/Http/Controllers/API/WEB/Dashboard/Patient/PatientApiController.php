...
namespace App\Http\Controllers\API\WEB\Dashboard\Patient;
...
class PatientApiController extends Controller
{
    ...
    public function patientDetails($id): \Illuminate\Http\JsonResponse
    {
        ...
        return $this->sendResponse(new \App\Http\Resources\WEB\Dashboard\Patient\DetailsPatientResource($patient), 'Patient details fetched successfully');
    }
